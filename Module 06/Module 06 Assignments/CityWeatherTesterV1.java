...
public class CityWeatherTesterV1
{
    ...
    public static void main (String [ ] args)
    {
        ...
        CityWeatherV1 weatherTester = new CityWeatherV1(month, temperature, precipitation);
        //print average temperature and total precipitation
        System.out.println("Average Temp: " + weatherTester.averageTemp() + ", Total Precipitation: " + weatherTester.totalPrecipitate());
