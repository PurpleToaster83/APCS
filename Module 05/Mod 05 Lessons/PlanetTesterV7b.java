 ...
 public class PlanetTesterV7b
{
   ...
   public static void main (String [] args) {
       ...
       // prints the planet3 object using toString method and then includes the radius calculation that is returned - notice the toString method does not need to be called
       System.out.println(planet3 + "   Radius: " + radius); 
       ...
       // prints the planet4 object using toString method and then includes the radius calculation that is returned - notice the toString method does not need to be called
       System.out.println(planet4 + "   Radius: " + radius); 
