...
public class ElectionTesterV7 {
    public static void deleteCand(Candidate[] candidates, int pos) {
        for(int index = pos; index < candidates.length - 1; index++) {
            candidates[index] = candidates[index + 1];
        }
        candidates[candidates.length - 1] = null;
    }

    public static void deleteCand(Candidate[] candidates, String name) {
        int location = 0;
    ...
    public static void main(String[] args) {
        ...
        */
        ...
        System.out.println();
        Candidate[] candidatesNewer = insertBefore(candidatesNew, "Candidate B", "Candidate W", 345);
        printTable(candidatesNewer, totalVotes(candidatesNewer));
        System.out.println();
        System.out.println("Delete Candidate 4:");
        System.out.println();
        deleteCand(candidatesNewer, 3);
        printTable(candidatesNewer, totalVotes(candidates));
        System.out.println();
        System.out.println("Delete Candidate A");
        System.out.println();
        deleteCand(candidatesNewer, "Candidate A");
        printTable(candidatesNewer, totalVotes(candidates));
    }
}
